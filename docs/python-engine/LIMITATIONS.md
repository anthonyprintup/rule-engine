...
- **Revisit:** Add tenant-aware registry quotas and retention/garbage collection, platform event adapters, phase-aware worker cancellation, an alternative atomic publication protocol, distributed stage/rollback orchestration, and policy versioning with failure-injection tests.
