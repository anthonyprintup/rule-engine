...
- The generic VM contract lacks cumulative cross-retry resource counters and typed emitted-event payloads, so those guarantees cannot yet be enforced end to end.
